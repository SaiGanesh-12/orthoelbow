...
class PtComplaints extends StatefulWidget {
  final String pid;
  const PtComplaints({Key? key, required this.pid}) : super(key: key);

  @override
  State<PtComplaints> createState() => _PtComplaintsState();
}

class _PtComplaintsState extends State<PtComplaints> {
  ...
  void _updateDoctorSuggestion() {
    ...
    FirebaseFirestore.instance.collection('patients').doc(widget.pid).update({'pc': patientComplaintController.text}).then((_) {
